  ...
  return (
    <section className="p-8 flex flex-col items-center text-center">
      ...
      <p className="text-lg max-w-xl text-gray-700">
        Hello, I'm a knowledgeable Web Developer and System Administrator, with practice
        in Cisco technologies, full stack development, version control,
        and network configuration. Driven by a desire to constantly be
        learning. 
      </p>
